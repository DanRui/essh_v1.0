...
<ul>
	...
	<li>前台由EasyUI1.3.4编写，后台是Java编写，应用框架struts2+spring3+hibernate+ehcache.</li><br />
</ul> 
...
<ul>
	<li>
		jQuery EasyUI、Kindeditor、Jackson、Struts2、Spring、Spring JDBC、Quartz、Hibernate、Ehcache、Hibernate Validator
	</li>
</ul> 
<h3 style="margin-left: 12px;">
	功能介绍
...
<ul>
    <li>
        权限系统:基于Struts2自定义拦截器的权限管理，包含以下模块：资源（模块）管理、角色管理、用户管理、组织机构管理等.<br/>
	...
	<li>
		对象缓存:使用Spring3.1注解方式，只需简单的注解即可完成对象的缓存、更新，例如对用户菜单的缓存.
	</li>
	<br />
