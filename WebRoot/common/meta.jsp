...
<link rel="stylesheet" type="text/css" href="${ctx}/js/jquery/easyui-1.3.2/portal/portal.css">

<!-- 引入jQuery -->
<script type="text/javascript" src="${ctx}/js/jquery/easyui-1.3.2/jquery.js" charset="utf-8"></script>
...
%>
<link id="easyuiTheme" rel="stylesheet" type="text/css" href="${ctx}/js/jquery/easyui-1.3.2/themes/<%=easyuiThemeName%>/easyui.css" />
<link rel="stylesheet" type="text/css" href="${ctx}/js/jquery/easyui-1.3.2/themes/icon.css" />
<script type="text/javascript" src="${ctx}/js/jquery/easyui-1.3.2/jquery.easyui.min.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/js/jquery/easyui-1.3.2/portal/jquery.portal.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/js/jquery/easyui-1.3.2/easyui-lang-zh_CN.js" charset="utf-8"></script>
