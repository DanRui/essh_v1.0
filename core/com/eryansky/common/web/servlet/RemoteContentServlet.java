 ...
 * <br>
 * 使用多线程安全的Apache HttpClient获取远程静态内容.
 * 
 * <br>参数:
 * <br>1、contentUrl: 远程url地址(get方式可加参数)
 * <br>2、client: 为'apache'则使用Apache HttpClient 否则使用JDK HttpUrlConnection
 * 
...
public class RemoteContentServlet extends HttpServlet {
	...
	private static Logger logger = LoggerFactory
			.getLogger(RemoteContentServlet.class);
	 ...
	 * 使用HttpClient取得内容.
	 */
	private void fetchContentByApacheHttpClient(HttpServletResponse response,
		...
		// 404返回
		if (entity == null) {
			response.sendError(HttpServletResponse.SC_NOT_FOUND, contentUrl
					+ " is not found.");
			return;
		}
	...
	private void fetchContentByJDKConnection(HttpServletResponse response,
			String contentUrl) throws IOException {
