...
//		System.out.println(spellMap.size());//大小396
	}
	 ...
	 * @param isFirstUpperCase 是否将首字母转换为大写 是true 否false
	 * @return String 转换成全拼后的字符串
	 * @throws UnsupportedEncodingException
	 */
	public static String getFullSpell(String cnStr,boolean isFirstUpperCase)
			throws UnsupportedEncodingException {
...
//		String str = null;
//		str = "健宝 123abc!@#$%^&*()";
//		System.out.println("Spell=" + HanziToPinYin.getFullSpell(str));
//		System.out.println("Spell First=" + HanziToPinYin.getFirstSpell(str));
		
		String str = "南昌";
		System.out.println(HanziToPinYin.getFirstSpell(str));
		System.out.println(HanziToPinYin.getFullSpell(str,true));
